...
function SVGChore(props: Props) {
  const { classNames } = props;
  return (
    <svg className={`bi bi-wrench ${classNames}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
